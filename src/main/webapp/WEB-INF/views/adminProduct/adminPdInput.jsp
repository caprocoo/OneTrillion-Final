                ...
                <div style="float:right; width: 1500px;height: 100%; margin-bottom:40px;">
                    <div
                        ...
                        <span class="ck_warn pd_seq_warn">상품 번호를 입력해주세요.</span></td>
                                ...
                                <tr>
                                    <th>상품명</th>
                                    <td><input type="text" class="form-control" placeholder="" id="pd_name"
                                            name="pd_name"></td>
                                    <td><span class="ck_warn pd_name_warn">상품명을 입력해주세요.</span></td>
                                </tr>
                                <tr>
                                    <th>상품가격</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요 (ex. 200000)" id="pd_price"
                                            name="pd_price"></td>
                                ...
                                <tr>
                                    <th>키워드</th>
                                    <td><input type="text" class="form-control" placeholder="한글로 입력해주세요 (ex. 한옥마을)" id="pd_keyword"
                                            name="pd_keyword">
                                ...
                                <tr>
                                    <th>출발일</th>
                                    <td><input type="date" class="form-control" placeholder="출발일을 선택해주세요"
                                            id="pd_startDate" name="pd_startDate">
                                ...
                                <tr>
                                    <th>도착일</th>
                                    <td><input type="date" class="form-control" placeholder="도착일을 선택해주세요" id="pd_endDate"
                                            name="pd_endDate">
                                    </td>
                                ...
                                <tr>
			                        <th>조회수</th>
			                        <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요" id="pd_cnt" name="pd_cnt"></td>
			                        <td><span class="ck_warn pd_cnt_warn">조회수를 입력해주세요.</span></td>
                    			</tr> 
                                <tr>
                                    <th>테마</th>
                                    <td><input type="text" class="form-control" placeholder="영어 소문자로 입력해주세요 (ex. pet)" id="pd_theme"
                                            name="pd_theme">
                                    </td>
                                ...
                                <tr>
                                    <th>인원</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요" id="pd_people"
                                            name="pd_people">
                                    </td>
                                ...
                                <tr>
                                    <th>지역</th>
                                    <td><input type="text" class="form-control" placeholder="영어 소문자로 입력해주세요 (ex. seoul) "
                                            id="pd_location" name="pd_location">
                                    </td>
                                    <td><span class="ck_warn pd_location_warn">지역을 입력해주세요.</span></td>
                                </tr>
                                <tr>
                                    <th>성인 인원</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요" id="adult_num"
                                            name="adult_num">
                                    </td>
                                ...
                                <tr>
                                    <th>미성년자 인원</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요"
                                            id="teenager_num" name="teenager_num">
                                    </td>
                                    <td><span class="ck_warn teenager_num_warn">미성년자 인원을 입력해주세요.</span></td>
                                </tr>
                                <tr>
                                    <th>반려동물 수</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요" id="pet_num"
                                            name="pet_num">
                                    </td>
                                ...
                                <tr>
                                    <th>성인 추가요금</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요 (ex. 200000)"
                                            id="adult_price" name="adult_price">
                                    </td>
                                ...
                                <tr>
                                    <th>미성년자 추가요금</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요 (ex. 200000)"
                                            id="teenager_price" name="teenager_price">
                                    </td>
                                    <td><span class="ck_warn teenager_price_warn">미성년자 추가요금을 입력해주세요.</span></td>
                                </tr>
                                <tr>
                                    <th>반려동물 추가요금</th>
                                    <td><input type="text" class="form-control" placeholder="숫자로만 입력해주세요 (ex. 200000)" id="pet_price"
                                            name="pet_price">
                                    </td>
                                ...
                                <tr>
                                    <th>대표이미지 선택</th>
                                    <td>
                                        <input type="file" class="form-control" id="pd_image" name="pd_image">
                                    </td>
                                    <td><span class="ck_warn pd_image_warn">대표이미지를 입력해주세요.</span></td>
                                </tr>
                                <tr>
                                    <th>컨텐츠 1</th>
                                    <td colspan="2" style="padding: 0;"><textarea class="form-control"
                                            id="exampleFormControlTextarea1" rows="4" placeholder="컨텐츠을 입력해주세요"
                                ...
                                <tr>
                                    <th>상품이미지 1</th>
                                    <td colspan="2">
                                        <input type="file" class="form-control" id="pd_contentImage1"
                                            name="pd_contentImage1">
                                    </td>
                                </tr>
                                <tr>
                                    <th>컨텐츠2</th>
                                    <td colspan="2" style="padding: 0;"><textarea class="form-control"
                                            id="exampleFormControlTextarea2" rows="4" placeholder="컨텐츠를 입력해주세요"
                                            style="border:0; resize: none; background-color: white;"
                                ...
                                <tr>
                                    <th>상품이미지2</th>
                                    <td colspan="2">
                                        <input type="file" class="form-control" id="pd_contentImage2"
                                            name="pd_contentImage2">
                                    </td>
                                </tr>
                                <tr>
                                    <th>컨텐츠3</th>
                                    <td colspan="2" style="padding: 0;"><textarea class="form-control"
                                            id="exampleFormControlTextarea3" rows="4" placeholder="컨텐츠을 입력해주세요"
                                            style="border:0; resize: none; background-color: white;"
                                ...
                                <tr>
                                    <th>상품이미지3</th>
                                    <td colspan="2">
                                        <input type="file" class="form-control" id="pd_contentImage3"
                                            name="pd_contentImage3">
                                    </td>
                                </tr>
                                <tr>
                                    <th>컨텐츠4</th>
                                    <td colspan="2" style="padding: 0;"><textarea class="form-control"
                                            id="exampleFormControlTextarea4" rows="4" placeholder="컨텐츠를 입력해주세요"
                                            style="border:0; resize: none; background-color: white;"
                                ...
                                <tr>
                                    <th>상품이미지4</th>
                                    <td colspan="2">
                                        <input type="file" class="form-control" id="pd_contentImage4"
                                            name="pd_contentImage4">
                                    </td>
                                </tr>
                                <tr>
                                    <th>컨텐츠5</th>
                                    <td colspan="2" style="padding: 0;"><textarea class="form-control"
                                            id="exampleFormControlTextarea5" rows="4" placeholder="컨텐츠를 입력해주세요"
                                            style="border:0; resize: none; background-color: white;"
                                ...
                                <tr>
                                    <th>상품이미지5</th>
                                    <td colspan="2">
                                        <input type="file" class="form-control" id="pd_contentImage5"
                                            name="pd_contentImage5">
                                    </td>
                                </tr>
                            </table>
                            <div style="text-align: right;">
                                <a class="btn btn-secondary" href="#" role="button"
                                    style="margin-top:10px; margin-bottom: 10px;" onclick="moveTop()">상단으로 이동</a>
                                <a class="btn btn-secondary" href="http://localhost:8088/trip/adminProduct/list.do"
        ...
        <script>
            $(document).ready(function () {
                document.getElementById('input').onclick = function () {
                    ...
                    var pd_image = $("input[name='pd_image']").val();
                    
                    var pd_contentImage1 = $("input[name='pd_contentImage1']").val();
                    var pd_contentImage2 = $("input[name='pd_contentImage2']").val();
                    var pd_contentImage3 = $("input[name='pd_contentImage3']").val();
                    var pd_contentImage4 = $("input[name='pd_contentImage4']").val();
                    var pd_contentImage5 = $("input[name='pd_contentImage5']").val();
