        ...
        <jsp:include page="../include/header2.jsp"></jsp:include>
          <div style="margin:auto; width:1100px; height:100%; min-height: 800px;">            
            <div style="float:right;width:1100px;">
              ...
              <input class="btn btn-secondary" type="button" value="목록으로"
	          ...
	          <div style="float: right;">            
				...
				<c:if test="${ u_id eq session_u_id}">					
				     <input class="btn btn-secondary" type="button" value="글 삭제"
	                                onclick="cl_btn_delete(${dto.com_seq  })" style="margin-top:10px; height: 40px;">   
	         		 <input class="btn btn-secondary" type="button" value="글 수정"
	                                  onclick="location.href='<%=request.getContextPath() %>/community/modify.do?com_seq=${dto.com_seq }' "
	                                      style="margin-top:10px; height: 40px;">
				</c:if>
		     </div>                    
            </div>
