		...
		<body>
			...
			<div style="margin:auto; width: 1300px;margin-top: 40px;">
				...
				<div style="margin: auto; width: 1300px; height: auto;">
					<div style="margin:auto; width:1300px; height:550px;">
						...
						<!-- swiper 부분끝-->
						<div style="float: left; width:500px;height: 550px; ">
							<table style="width: 100%; height: 100%;" border="1px solid red">
								<tr>
									<td style="padding: 10px;">
										<h6>
											<div>
												<div style="float: left; margin-bottom: 5px;">상품번호 : ${dto.pd_seq }
												</div>
												<div style="float: right;">조회수 : ${dto.pd_cnt }회</div>
											</div>
											<div style="clear: both;">
												<div style="float: left;">리뷰 : </div>
												<div style="float: right;">
													<span class="star1 star101" data-rate="1">★</span><span
														class="star1 star102" data-rate="2">★</span><span
														class="star1 star103" data-rate="3">★</span><span
														class="star1 star104" data-rate="4">★</span><span
														class="star1 star105" data-rate="5">★</span>
													<span class="star1Score"></span>/5
												</div>
											</div>
										</h6>
									</td>
			...
			<div style="margin:auto;width:1300px;height:auto; margin-top: 10px; ">
				<div id="detailDiv001"
					...
					<div>
						<input type="button" class="btn btn-secondary"
							style="width: 100%; height: 45px; margin-bottom: 5px;" onclick="Like_click()" value="찜" />
					</div>
							...
							<tr class="detailRevTr01"
								...
								<td>
									<span class="star star01" data-rate="1">★</span><span class="star star02"
										...
										data-rate="5">★</span> <span class="starScore"></span>/5
								</td>
								<td></td>
								<td></td>
							</tr>
							...
							<li class="page-item">
								<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
									<a class="page-link" href="listPage.do${pageMaker.makeQuery(idx)}"
										style="color: gray;border:1px solid #ededed"></a>
								</c:forEach>
							</li>
