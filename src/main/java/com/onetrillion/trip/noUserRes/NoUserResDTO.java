package com.onetrillion.trip.noUserRes;

import java.time.LocalDate;

import org.springframework.format.annotation.DateTimeFormat;

public class NoUserResDTO {
	private int res_seq; // 예약 번호 - primary key 
	private String res_pwd; // 예약확인 비밀번호
	...
	public String toString() {
		return "NoUserResDTO [res_seq=" + res_seq + ", res_pwd=" + res_pwd + ", pd_seq=" + pd_seq + ", pd_name="
				+ pd_name + ", pd_startDate=" + pd_startDate + ", pd_endDate=" + pd_endDate + ", adult_num=" + adult_num
