...
public class BoardDTO {
	...
	private MultipartFile uploadFile, uploadFile1, uploadFile2, uploadFile3, uploadFile4, uploadFile5;
	...
	public BoardDTO(int pd_seq, String pd_name, int pd_price, String pd_keyword, LocalDate pd_startDate,
			...
			String pd_contentImage5, MultipartFile uploadFile, MultipartFile uploadFile1, MultipartFile uploadFile2, MultipartFile uploadFile3, MultipartFile uploadFile4, MultipartFile uploadFile5) {
		this.pd_seq = pd_seq;
	...
	public String toString() {
		return "BoardDTO [pd_seq=" + pd_seq + ", pd_name=" + pd_name + ", pd_price=" + pd_price + ", pd_keyword="
				...
				+ ", pd_contentImage4=" + pd_contentImage4 + ", pd_contentImage5=" + pd_contentImage5 + ", uploadFile="
